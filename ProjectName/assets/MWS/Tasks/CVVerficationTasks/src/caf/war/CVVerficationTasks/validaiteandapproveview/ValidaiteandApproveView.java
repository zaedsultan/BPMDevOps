...
@ManagedBean(name = "ValidaiteandApproveView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ValidaiteandApproveView", beanType = BeanType.PORTLET)
public class ValidaiteandApproveView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public ValidaiteandApproveView() {
